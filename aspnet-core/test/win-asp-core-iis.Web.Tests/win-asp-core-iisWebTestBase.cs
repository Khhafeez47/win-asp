...
{
    public abstract class win-asp-core-iisWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static win-asp-core-iisWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(win-asp-core-iisWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<win-asp-core-iisDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<win-asp-core-iisDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<win-asp-core-iisDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<win-asp-core-iisDbContext, Task<T>> func)
        {
            T result;
