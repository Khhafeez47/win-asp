...
namespace win-asp-core-iis.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = win-asp-core-iisConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(win-asp-core-iisDbContext context)
        {
            _context = context;
        }
